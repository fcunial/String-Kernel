...
void SLT_MAWs_callback(const SLT_joint_params_t * SLT_params,void * intern_state, unsigned int memory);
...
unsigned int SLT_find_MAWs(Basic_BWT_t * BBWT1,Basic_BWT_t * BBWT2,
		unsigned int minlen, unsigned int * nMAWs1,unsigned int * nMAWs2, double * LW,unsigned int mem, unsigned int cores);
