...
unsigned int *new_basic_DNA5_seq(unsigned int seqlen, unsigned int *_output_size);

void complete_basic_DNA5_seq(unsigned int *indexed_seq, unsigned int seqlen);

unsigned int *build_basic_DNA5_seq(unsigned char *orig_seq, unsigned int seqlen, unsigned int *_output_size, unsigned int *count);
